...
export function monkeypatchSheet(ItemResources) {
  ...
  if (typeof libWrapper === "function") {
    libWrapper.register("resourcesplus", "game.dnd5e.applications.ItemSheet5e.prototype._getItemConsumptionTargets", wrapperFunction, "OVERRIDE");
  } else {
    game.dnd5e.applications.ItemSheet5e.prototype._getItemConsumptionTargets = wrapperFunction;
  }
}
